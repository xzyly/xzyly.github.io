...
graph TD
    subgraph 二维DP矩阵 f[i][j]
        A0[0] --> A1[1] --> A2[2] --> A3[...] --> A4[m]
        B0[物品0] --> B1[0] --> B2[0] --> B3[0] --> B4[0]
        C0[物品1] --> C1[计算值] --> C2[计算值] --> C3[...] --> C4[计算值]
        D0[物品2] --> D1[计算值] --> D2[计算值] --> D3[...] --> D4[计算值]
        E0[...] --> E1[...] --> E2[...] --> E3[...] --> E4[...]
        F0[物品n] --> F1[最终结果] --> F2[最终结果] --> F3[最终结果] --> F4[最终结果]
    end
    
    subgraph 状态转移
        G[状态转移方程<br>f[i][j] = max(f[i-1][j], f[i-1][j-w[i]] + v[i])]
    end
...
graph LR
    subgraph 一维DP数组 f[j]
        A0[0] --> A1[1] --> A2[2] --> A3[...] --> A4[m]
        B0[初始: 0] --> B1[0] --> B2[0] --> B3[0] --> B4[0]
        C0[迭代1后] --> C1[值1] --> C2[值2] --> C3[...] --> C4[值m]
        D0[迭代2后] --> D1[更新值1] --> D2[更新值2] --> D3[...] --> D4[更新值m]
        E0[最终] --> E1[结果1] --> E2[结果2] --> E3[结果...] --> E4[结果m]
    end
    
    subgraph 状态转移
        F[状态转移方程<br>f[j] = max(f[j], f[j-w[i]] + v[i])]
    end
    
    subgraph 方向
        G[遍历方向: <br>物品从上到下，容量从右到左]
    end
